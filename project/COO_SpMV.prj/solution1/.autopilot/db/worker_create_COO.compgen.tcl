...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row \
    op interface \
    ports { row_address0 { O 12 vector } row_ce0 { O 1 bit } row_we0 { O 1 bit } row_d0 { O 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename col \
    op interface \
    ports { col_address0 { O 12 vector } col_ce0 { O 1 bit } col_we0 { O 1 bit } col_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename nnz \
    op interface \
    ports { nnz_address0 { O 5 vector } nnz_ce0 { O 1 bit } nnz_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'nnz'"
}
}
