...
set id 1
set name worker_fcmp_32ns_32ns_1_1
...
set ID 2
set MemName worker_create_COO_temp_row
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName worker_create_COO_temp_col
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 7
set AddrRange 2500
...
# Memory (RAM/ROM)  definition:
set ID 4
set MemName worker_create_COO_temp_val
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 2500
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row \
    op interface \
    ports { row_address0 { O 12 vector } row_ce0 { O 1 bit } row_we0 { O 1 bit } row_d0 { O 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename col \
    op interface \
    ports { col_address0 { O 12 vector } col_ce0 { O 1 bit } col_we0 { O 1 bit } col_d0 { O 7 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename val_r \
    op interface \
    ports { val_r_address0 { O 12 vector } val_r_ce0 { O 1 bit } val_r_we0 { O 1 bit } val_r_d0 { O 32 vector } } \
} "
} else {
