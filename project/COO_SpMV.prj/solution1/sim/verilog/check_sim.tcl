...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.COO_SpMV.autotvin_row.dat"
         "c.COO_SpMV.autotvin_col.dat"
         "c.COO_SpMV.autotvin_val_r.dat"
         "c.COO_SpMV.autotvin_vector.dat"
         "c.COO_SpMV.autotvin_output_r.dat"
         "c.COO_SpMV.autotvin_nnz.dat"
         "c.COO_SpMV.autotvout_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.COO_SpMV.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
