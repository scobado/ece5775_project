...
if {[file isfile COO_SpMV.autotvin.dat]} {
	file delete -force COO_SpMV.autotvin.dat
}

if {[file isfile COO_SpMV.autotvout.dat]} {
	file delete -force COO_SpMV.autotvout.dat
}
