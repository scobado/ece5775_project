...
parameter    ap_const_lv12_D05 = 12'b110100000101;
...
reg    ap_sig_20;
wire   [11:0] row10_1_0_address0;
reg    row10_1_0_ce0;
wire   [7:0] row10_1_0_q0;
wire   [11:0] val10_1_0_address0;
reg    val10_1_0_ce0;
wire   [31:0] val10_1_0_q0;
wire   [11:0] col10_1_0_address0;
reg    col10_1_0_ce0;
wire   [7:0] col10_1_0_q0;
...
wire   [11:0] i_1_fu_130_p2;
wire   [63:0] tmp_fu_136_p1;
reg   [63:0] tmp_reg_172;
wire   [0:0] tmp_4_fu_145_p3;
reg   [0:0] tmp_4_reg_183;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter2;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter3;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter4;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter5;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter6;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter7;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter8;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter9;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter10;
reg   [0:0] ap_reg_ppstg_tmp_4_reg_183_pp0_iter11;
reg   [6:0] output_addr_reg_197;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter2;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter3;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter4;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter5;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter6;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter7;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter8;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter9;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter10;
reg   [6:0] ap_reg_ppstg_output_addr_reg_197_pp0_iter11;
reg   [31:0] val10_1_0_load_reg_203;
wire   [31:0] grp_fu_119_p2;
reg   [31:0] tmp_s_reg_218;
reg   [31:0] output_load_reg_223;
wire   [31:0] grp_fu_115_p2;
reg   [31:0] tmp_2_reg_228;
wire   [63:0] tmp_1_fu_153_p1;
wire  signed [63:0] tmp_9_fu_158_p1;
wire  signed [31:0] row10_1_0_load_cast_fu_141_p1;
...
worker_fadd_32ns_32ns_32_5_full_dsp #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
worker_fadd_32ns_32ns_32_5_full_dsp_U1(
    .clk(ap_clk),
    .reset(ap_rst),
...
worker_fmul_32ns_32ns_32_4_max_dsp #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
worker_fmul_32ns_32ns_32_4_max_dsp_U2(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b0 == tmp_4_fu_145_p3))) begin
        output_addr_reg_197 <= tmp_1_fu_153_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it6) & (1'b0 == ap_reg_ppstg_tmp_4_reg_183_pp0_iter5))) begin
        output_load_reg_223 <= output_r_q0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_reg_ppstg_tmp_4_reg_183_pp0_iter10)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1)) begin
        tmp_4_reg_183 <= row10_1_0_q0[ap_const_lv32_7];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (exitcond_fu_124_p2 == 1'b0))) begin
        tmp_reg_172[11 : 0] <= tmp_fu_136_p1[11 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_reg_ppstg_tmp_4_reg_183_pp0_iter5)) begin
        tmp_s_reg_218 <= grp_fu_119_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == tmp_4_reg_183)) begin
...
always @ (*) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it12) & (1'b0 == ap_reg_ppstg_tmp_4_reg_183_pp0_iter11))) begin
        output_r_we1 = 1'b1;
    end else begin
        output_r_we1 = 1'b0;
    end
...
assign col10_1_0_address0 = tmp_reg_172;

assign exitcond_fu_124_p2 = ((i_reg_104 == ap_const_lv12_D05) ? 1'b1 : 1'b0);

assign i_1_fu_130_p2 = (i_reg_104 + ap_const_lv12_1);
...
assign output_r_d1 = tmp_2_reg_228;

assign row10_1_0_address0 = tmp_fu_136_p1;

assign row10_1_0_load_cast_fu_141_p1 = $signed(row10_1_0_q0);

assign tmp_1_fu_153_p1 = $unsigned(row10_1_0_load_cast_fu_141_p1);

assign tmp_4_fu_145_p3 = row10_1_0_q0[ap_const_lv32_7];

assign tmp_9_fu_158_p1 = $signed(col10_1_0_q0);

assign tmp_fu_136_p1 = i_reg_104;

assign val10_1_0_address0 = tmp_reg_172;

assign vector_address0 = tmp_9_fu_158_p1;

always @ (posedge ap_clk) begin
    tmp_reg_172[63:12] <= 52'b0000000000000000000000000000000000000000000000000000;
end

endmodule //worker_COO_SpMV_0
