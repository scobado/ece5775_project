...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "worker.autotvin.dat"
	set constFileTvOut       "worker.autotvout.dat"
	set constFileHdlTvIn     "worker.autohdltvin.dat"
	set constFileHdlTvOut    "worker.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
