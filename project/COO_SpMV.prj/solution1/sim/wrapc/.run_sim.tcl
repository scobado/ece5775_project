...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "COO_SpMV.autotvin.dat"
	set constFileTvOut       "COO_SpMV.autotvout.dat"
	set constFileHdlTvIn     "COO_SpMV.autohdltvin.dat"
	set constFileHdlTvOut    "COO_SpMV.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
