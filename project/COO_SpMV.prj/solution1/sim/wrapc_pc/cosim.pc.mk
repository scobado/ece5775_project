...
$(ObjDir)/COO_SpMV_test.cpp_pre.cpp.tb.o : COO_SpMV_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling COO_SpMV_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/COO_SpMV.cpp_pre.cpp.tb.o : COO_SpMV.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling COO_SpMV.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
