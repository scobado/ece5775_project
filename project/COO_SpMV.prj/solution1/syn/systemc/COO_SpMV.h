...
struct COO_SpMV : public sc_module {
    ...
    sc_signal< sc_lv<14> > i_2_fu_193_p2;
    sc_signal< sc_lv<1> > tmp_2_fu_203_p2;
    sc_signal< sc_lv<1> > tmp_2_reg_248;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter1;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter3;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter4;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter5;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter6;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter7;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter8;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter9;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_2_reg_248_pp0_iter10;
    sc_signal< sc_lv<32> > val_load_reg_267;
    sc_signal< sc_lv<7> > output_addr_1_reg_277;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter2;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter3;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter4;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter5;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter6;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter7;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter8;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter9;
    sc_signal< sc_lv<7> > ap_reg_ppstg_output_addr_1_reg_277_pp0_iter10;
    sc_signal< sc_lv<32> > grp_fu_165_p2;
    sc_signal< sc_lv<32> > tmp_5_reg_288;
    sc_signal< sc_lv<32> > output_load_reg_293;
    sc_signal< sc_lv<32> > grp_fu_161_p2;
    sc_signal< sc_lv<32> > tmp_7_reg_298;
    sc_signal< sc_lv<7> > i_reg_139;
    sc_signal< sc_lv<64> > tmp_fu_182_p1;
    sc_signal< sc_lv<64> > tmp_3_fu_208_p1;
    sc_signal< sc_lv<64> > tmp_4_fu_215_p1;
    sc_signal< sc_lv<64> > tmp_6_fu_220_p1;
    sc_signal< sc_lv<32> > i1_cast1_fu_199_p1;
    ...
    void thread_i1_cast1_fu_199_p1();
