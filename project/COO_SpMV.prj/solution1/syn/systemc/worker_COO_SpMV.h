...
struct worker_COO_SpMV : public sc_module {
    ...
    sc_signal< sc_lv<12> > i_5_fu_137_p2;
    sc_signal< sc_lv<1> > tmp_fu_147_p2;
    sc_signal< sc_lv<1> > tmp_reg_182;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter1;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter2;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter3;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter4;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter5;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter6;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter7;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter8;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter9;
    sc_signal< sc_lv<1> > ap_reg_ppstg_tmp_reg_182_pp0_iter10;
    ...
    sc_signal< sc_lv<32> > tmp_3_reg_237;
