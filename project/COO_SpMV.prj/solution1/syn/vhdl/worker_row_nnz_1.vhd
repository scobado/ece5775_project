...
entity worker_row_nnz_1_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 5; 
             mem_size    : integer := 25
...
architecture rtl of worker_row_nnz_1_rom is 
...
signal mem : mem_array := (
    ...
    4 to 5=> "00000000000000000000000000000010", 
    ...
    15 to 18=> "00000000000000000000000000000000", 
...
architecture arch of worker_row_nnz_1 is
    component worker_row_nnz_1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    worker_row_nnz_1_rom_U :  component worker_row_nnz_1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
