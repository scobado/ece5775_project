...
const float transposed_9[PE][block_size][size] = {
    #include"data/transposed_9.dat"
};

const float transposed_8[PE][block_size][size] = {
    #include"data/transposed_8.dat"
};

const float transposed_7[PE][block_size][size] = {
    #include"data/transposed_7.dat"
};

const float transposed_6[PE][block_size][size] = {
    #include"data/transposed_6.dat"
};

const float transposed_5[PE][block_size][size] = {
    #include"data/transposed_5.dat"
};

const float transposed_4[PE][block_size][size] = {
    #include"data/transposed_4.dat"
};

const float transposed_3[PE][block_size][size] = {
    #include"data/transposed_3.dat"
};

const float transposed_2[PE][block_size][size] = {
    #include"data/transposed_2.dat"
};

const float transposed_1[PE][block_size][size] = {
    #include"data/transposed_1.dat"
};

// const float transposed_10[size][size] = {
//     #include"data/transposed_10.dat"
// };

// const float transposed_9[size][size] = {
//     #include"data/transposed_9.dat"
// };

// const float transposed_8[size][size] = {
//     #include"data/transposed_8.dat"
// };

// const float transposed_7[size][size] = {
//     #include"data/transposed_7.dat"
// };

// const float transposed_6[size][size] = {
//     #include"data/transposed_6.dat"
// };

// const float transposed_5[size][size] = {
//     #include"data/transposed_5.dat"
// };

// const float transposed_4[size][size] = {
//     #include"data/transposed_4.dat"
// };

// const float transposed_3[size][size] = {
//     #include"data/transposed_3.dat"
// };

// const float transposed_2[size][size] = {
//     #include"data/transposed_2.dat"
// };

// const float transposed_1[size][size] = {
//     #include"data/transposed_1.dat"
// };
