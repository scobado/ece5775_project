...
reg    ap_sig_20;
wire   [7:0] row10_25_4_address0;
reg    row10_25_4_ce0;
wire   [2:0] row10_25_4_q0;
wire   [7:0] val10_25_4_address0;
reg    val10_25_4_ce0;
wire   [31:0] val10_25_4_q0;
wire   [7:0] col10_25_4_address0;
reg    col10_25_4_ce0;
wire   [7:0] col10_25_4_q0;
wire   [6:0] v_address0;
reg    v_ce0;
wire   [31:0] v_q0;
reg   [7:0] i_reg_104;
...
wire   [0:0] tmp_16_fu_145_p3;
reg   [0:0] tmp_16_reg_183;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter2;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter3;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter4;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter5;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter6;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter7;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter8;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter9;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter10;
reg   [0:0] ap_reg_ppstg_tmp_16_reg_183_pp0_iter11;
...
reg   [31:0] val10_25_4_load_reg_203;
...
row10_25_4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .address0(row10_25_4_address0),
    .ce0(row10_25_4_ce0),
    .q0(row10_25_4_q0)
);

dut_COO_SpMV_20_val10_25_4 #(
    .DataWidth( 32 ),
    .AddressRange( 133 ),
    .AddressWidth( 8 ))
val10_25_4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .address0(val10_25_4_address0),
    .ce0(val10_25_4_ce0),
    .q0(val10_25_4_q0)
);

dut_COO_SpMV_20_col10_25_4 #(
    .DataWidth( 8 ),
    .AddressRange( 133 ),
    .AddressWidth( 8 ))
col10_25_4_U(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == 1'b1)) begin
        ...
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter10 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter9;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter11 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter10;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter2 <= tmp_16_reg_183;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter3 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter2;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter4 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter3;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter5 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter4;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter6 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter5;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter7 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter6;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter8 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter7;
        ap_reg_ppstg_tmp_16_reg_183_pp0_iter9 <= ap_reg_ppstg_tmp_16_reg_183_pp0_iter8;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (1'b0 == tmp_16_fu_145_p3))) begin
        output_addr_reg_197 <= tmp_3_fu_153_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it6) & (1'b0 == ap_reg_ppstg_tmp_16_reg_183_pp0_iter5))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_1)) begin
        tmp_16_reg_183 <= row10_25_4_q0[ap_const_lv32_2];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_reg_ppstg_tmp_16_reg_183_pp0_iter5)) begin
        tmp_2_reg_218 <= grp_fu_119_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_reg_ppstg_tmp_16_reg_183_pp0_iter10)) begin
        tmp_4_reg_228 <= grp_fu_115_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == tmp_16_reg_183)) begin
        val10_25_4_load_reg_203 <= val10_25_4_q0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_reg_ppiten_pp0_it12) & (1'b0 == ap_reg_ppstg_tmp_16_reg_183_pp0_iter11))) begin
        output_r_we1 = 1'b1;
    end else begin
        output_r_we1 = 1'b0;
    end
...
assign col10_25_4_address0 = tmp4_reg_172;
...
assign row10_25_4_address0 = tmp4_fu_136_p1;

assign row_load_cast_fu_141_p1 = $signed(row10_25_4_q0);

assign tmp4_fu_136_p1 = i_reg_104;

assign tmp_16_fu_145_p3 = row10_25_4_q0[ap_const_lv32_2];

assign tmp_1_fu_158_p1 = $signed(col10_25_4_q0);

assign tmp_3_fu_153_p1 = $unsigned(row_load_cast_fu_141_p1);

assign v_address0 = tmp_1_fu_158_p1;

assign val10_25_4_address0 = tmp4_reg_172;

always @ (posedge ap_clk) begin
    tmp4_reg_172[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end

endmodule //dut_COO_SpMV_20
